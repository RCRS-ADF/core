...
public class CommandAmbulance extends StandardMessage {
	...
	public CommandAmbulance(boolean isRadio, @Nullable EntityID toID, @Nullable EntityID targetID, @Nonnegative int action) {
		super(isRadio);
	...
	public CommandAmbulance(boolean isRadio, int from, int ttl, @Nonnull BitStreamReader bitStreamReader)
	{
